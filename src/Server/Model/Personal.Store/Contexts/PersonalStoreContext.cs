...
namespace odec.Server.Model.Personal.Store.Contexts
{
    public class PersonalStoreContext: DbContext, 
        IPersonalStoreContext<StoreE, Good, Type, Color, Size, Designer, Material, Categ, RelativeGood, StoreGood, GoodType, GoodColor, GoodMaterial, GoodDesigner, GoodCategory, GoodImage, GoodPriceChange,UserPersonalStore>
    {
        ...
        public DbSet<UserPersonalStore> UserStores { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserPersonalStore>()
                .ToTable("UserStores", StoreScheme)
                .HasKey(it => new { it.StoreId, it.UserId });
